...
sqrSize = 32
i = Image.open("D:\\Vapaa-aika\\Koodaus\\PaikkaTietoikkunaRuutuLaskuri\\images\\Isokyrö\\Kuusi.png")
...
def laskePuusto(imgaeArray):
	...
	puustoAla = (orange * 0 + brown * 1 + beige * 2 + fadedGreen * 4 + lightGreen * 8 + semiLightGreen * 16 + green * 30 + darkGreen * 53 + lightBlue * 96 + darkBlue * 185) * 0.0256
	puustoYla = (orange * 0 + brown * 1 + beige * 3 + fadedGreen * 7 + lightGreen * 15 + semiLightGreen * 29 + green * 52 + darkGreen * 95 + lightBlue * 184 + darkBlue * 185) * 0.0256
