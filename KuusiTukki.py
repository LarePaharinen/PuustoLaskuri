...
sqrSize = 64
i = Image.open("D:\\Vapaa-aika\\Koodaus\\PaikkaTietoikkunaRuutuLaskuri\\images\\Akaa\\kuusiTukki.png")
...
def laskePuusto(imgaeArray):
	...
	puustoAla = (orange * 0 + brown * 1 + beige * 2 + fadedGreen * 3 + lightGreen * 4 + semiLightGreen * 5 + green * 9 + darkGreen * 20 + lightBlue * 44 + darkBlue * 107) * 0.0256
	puustoYla = (orange * 0 + brown * 1 + beige * 2 + fadedGreen * 3 + lightGreen * 4 + semiLightGreen * 8 + green * 19 + darkGreen * 43 + lightBlue * 106 + darkBlue * 107) * 0.0256
