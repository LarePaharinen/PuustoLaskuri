...
sqrSize = 8
i = Image.open("D:\\Vapaa-aika\\Koodaus\\PaikkaTietoikkunaRuutuLaskuri\\images\\VMPuuREtelä.png")
...
def laskePuusto(imgaeArray):
	...
	puustoAla = (orange * 0 +  beige * 1 + lightGreen * 5 + green * 13 + darkGreen * 28 + lightBlue * 55) * 0.0256
	puustoYla = (orange * 0 +  beige * 4 + lightGreen * 12 + green * 28 + darkGreen * 54 + lightBlue * 55) * 0.0256
